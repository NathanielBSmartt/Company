...
public class Lab2 {
	...
	public static void main(String[] args) {
		...
		LimitedCommissionEmployee limitedCommission1 = new LimitedCommissionEmployee("Anderson", 0.15, 1000);

		LimitedCommissionEmployee limitedCommission2 = new LimitedCommissionEmployee("Fletcher", 0.20, 1200);

		LimitedCommissionEmployee limitedCommission3 = new LimitedCommissionEmployee("Cooper", 0.10, 1500);
		...
		LimitedCommissionEmployee limitedCommission4 = new LimitedCommissionEmployee("Davis", 0.2, 1800);
